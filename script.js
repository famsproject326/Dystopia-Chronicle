...
let gameMode = "EXPLORE"; // "EXPLORE" or "HACKING"
...
function loop() {
    ...
    if (gameMode === "EXPLORE") {
        ...
        ctx.fillText("TAP AI TO HACK", centerX, centerY + 100);
        ...
        ctx.fillText("(TAP AI TO RETURN)", canvas.width/2, canvas.height/2 + 40);
    }
